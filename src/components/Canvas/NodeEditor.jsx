...
const NodeEditor = ({ node, onSave, onClose, onBringToFront }) => {
  ...
  const handleNameChange = (e) => {
    ...
    const newId = (!formData.id || isAutoGeneratedId) ? name : formData.id;
                  ...
                  <div className="flex flex-wrap gap-1 max-h-24 overflow-y-auto p-1 bg-gray-50 rounded">
                    {availableNodes.map(n => (
                      <button
                        ...
                        className="text-xs px-2 py-1 bg-white hover:bg-blue-50 border rounded font-mono text-blue-700 hover:text-blue-800"
                      >
                        {n.id}
                      </button>
                    ))}
